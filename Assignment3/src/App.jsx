...
function App() {
  ...
  const TOKEN = "9cb69e61b765458d8be5f8efb2c99c68"
    ...
    <div className='app-container'>
      <form onSubmit={getHeroDataByName}>
        ...
        <div className='form-btns-container'>
          <button className='form-btn form-btn1' type='submit'>Find</button>
          <button className='form-btn form-btn2' onClick={getRandomHero} type='button'>Random</button>
        </div>
      </form>
